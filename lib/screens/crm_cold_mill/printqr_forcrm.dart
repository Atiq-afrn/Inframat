...
class PrintqrforCrm extends StatefulWidget {
  const PrintqrforCrm({super.key, this.batchNopickling, this.coilno});
  final String? batchNopickling;
  final String? coilno;

  @override
  State<PrintqrforCrm> createState() => _PrintqrforCrmState();
}

class _PrintqrforCrmState extends State<PrintqrforCrm> {
  @override
  void initState() {
