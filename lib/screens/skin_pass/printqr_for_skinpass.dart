...
class PrintQrforSkinpass extends StatefulWidget {
  const PrintQrforSkinpass({super.key, this.batchNo, this.coilno});
  final String? batchNo;
  final String? coilno;

  @override
  State<PrintQrforSkinpass> createState() => _PrintQrforSkinpassState();
}

class _PrintQrforSkinpassState extends State<PrintQrforSkinpass> {
  @override
  void initState() {
