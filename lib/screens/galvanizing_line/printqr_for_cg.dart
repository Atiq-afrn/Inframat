...
class PrintqrforCGl extends StatefulWidget {
  const PrintqrforCGl({super.key, this.batchNo, this.coilno});
  final String? batchNo;
  final String? coilno;

  @override
  State<PrintqrforCGl> createState() => _PrintqrforCGlState();
}

class _PrintqrforCGlState extends State<PrintqrforCGl> {
  @override
  void initState() {
