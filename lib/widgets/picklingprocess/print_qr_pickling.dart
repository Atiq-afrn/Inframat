...
class PrintqrforPickling extends StatefulWidget {
  const PrintqrforPickling({super.key, this.batchNopickling, this.coilno});
  final String? batchNopickling;
  final String? coilno;

  @override
  State<PrintqrforPickling> createState() => _PrintqrforPicklingState();
}

class _PrintqrforPicklingState extends State<PrintqrforPickling> {
  @override
  void initState() {
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "${widget.batchNopickling}",
                        style: TextStyle(fontSize: 12),
                      ),
                    ),

                    Text("${widget.coilno} ", style: TextStyle(fontSize: 12)),
                    GestureDetector(
                      onTap: () {
                        Provider.of<PrintQrCoderProvider>(
                          context,
                          listen: false,
                        ).gettingqrCodeData(widget.batchNopickling!).then((
                          value,
                        ) {
                          if (value != null) {
